...
#
# Модель для формирования заказа. Перед созданием заказа обязательно создайте клиента WebpayBy::Client.
#
...
module WebpayBy
  class Request
    ...
    # форме заказа. Заказы без электронной подписи не будут рассматриваться системой WebPay.
    def signature
